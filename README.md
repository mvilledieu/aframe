...
Experimental version of AFrame 0.9.2 adding support for the WebXR API used by MagicLeap helio in 0.96.0. Use at your own risk. Used while figuring out a way to fix the main AFrame lib.
